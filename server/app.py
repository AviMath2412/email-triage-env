...
async def grade_episode(request: dict):
    """
    Computes a final grade for a completed episode based on raw score
    and step efficiency.
    """
...
async def run_baseline(task_id: str | None = None):
    """
    Executes the built-in heuristic agent script against the specified task.
    Used for sanity checking and performance benchmarking.
    """
